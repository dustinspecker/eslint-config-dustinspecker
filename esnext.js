...
config.rules['class-methods-use-this'] = 2
...
config.rules['lines-between-class-members'] = 0
config.rules['no-arrow-condition'] = 0
config.rules['no-await-in-loop'] = 2
...
config.rules['no-return-await'] = 2
config.rules['no-template-curly-in-string'] = 2
